...
function LDPC = LDPC_heshani_500b_R23

  LDPC.name = 'LDPC_heshani_504b_R23.mat';
   
  LDPC.Z = 21; % subblock size
    
  H_r23_n504_z21 = {'25' '26' '14' '-' '20' '-' '2' '-' '4' '-' '-' '8' '-' '16' '-' '18' '1' '0' '-' '-' '-' '-' '-' '-';
   ...
   [row ,col] = size(H_r23_n504_z21);

%     prot = cell(row,col) ;
    
    for i=1:row
        for j=1:col
                if H_r23_n504_z21{i,j} ~= '-'
                    H_r23_n504_z21{i,j}= int2str( mod( str2double(H_r23_n504_z21{i,j}) , LDPC.Z ) );
                end
        end
    end
  %----------
    
  LDPC.H_prot =  H_r23_n504_z21;
