...
function LDPC = LDPC_heshani_120b_R23

  LDPC.name = 'LDPC_heshani_120b_R23.mat';
   
  LDPC.Z = 5; % subblock size
    
  H_r23_n120_z5 = {'25' '26' '14' '-' '20' '-' '2' '-' '4' '-' '-' '8' '-' '16' '-' '18' '1' '0' '-' '-' '-' '-' '-' '-';
   ...
   [row ,col] = size(H_r23_n120_z5);

%     prot = cell(row,col) ;
    
    for i=1:row
        for j=1:col
                if H_r23_n120_z5{i,j} ~= '-'
                    H_r23_n120_z5{i,j}= int2str( mod( str2double(H_r23_n120_z5{i,j}) , LDPC.Z ) );
                end
        end
    end
  %----------
    
  LDPC.H_prot =  H_r23_n120_z5;
