...
function LDPC = LDPC_heshani_2040b_R13

  LDPC.name = 'LDPC_heshani_2040b_R13.mat';
%    5670 bits. Sub-matrix dimension 378.
%   LDPC.Z = 378; % subblock size
  LDPC.Z = 136; % subblock size
  %----------
  LDPC_heshani_5670b_R13 =[ 
...
%         end
%     end
  LDPC_heshani_5670b_R13(LDPC_heshani_5670b_R13~=-1) = mod(LDPC_heshani_5670b_R13(LDPC_heshani_5670b_R13~=-1),LDPC.Z);
  %----------
    
  LDPC.H_prot = LDPC_heshani_5670b_R13;
